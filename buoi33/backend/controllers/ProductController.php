...
class ProductController extends Controller
{
    ...
    {   
        // Để xử lý form search sẽ xử lý chung phương thức khi hiển thị danh sách sản phẩm
        // tạo 1 mảng chứa các thông tin search, truyền mảng này vào trong phương thức hiển thị
        // danh sách sản phẩm
        // Debug mảng $_GET
        $params = [];
        echo "<pre>";
        ...
        // Lấy ra tất cả thông tin đang có trên hệ thống
        // echo "<pre>";
        // print_r($categories);
        // echo "</pre>";
