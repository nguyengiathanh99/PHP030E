...
class Order extends Model {
  ...
  note,price_total,payment_status) VALUES(:fullname, :address, :mobile, :email, :note, :price_total, :payment_status)";
  ...
  // Do cần trả về id của order vừa insert nên execute sẽ k cần gán biến
