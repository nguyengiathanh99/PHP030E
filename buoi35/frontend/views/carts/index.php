                ...
                <tr>
                    ...
                    <th></th>
                        ...
                        foreach($_SESSION['cart'] AS $product_id => $cart):
                            ...
                            // về dạng k dấu, ngăng cách các từ bởi ký tự
                ...
                <tr>
                    ...
                    <td>
                        <!-- cần khéo léo đặt name cho input số lượng,
                         để khi xử lý submit form update lại giỏ hànTin nổi bật sẽ đơn giản hơn
                         cần đặt name của số lượng chính là id sản phẩm    -->
                    ...
                    <td>
                        <?php $total_item = $cart['quantity'] * $cart['price'];
